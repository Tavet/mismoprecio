...
class DieselItem(scrapy.Item):
    uuid=scrapy.Field()  # UUID Hexadecimal
...
class DieselSpider(scrapy.Spider):
    ...
    def parse_clothes(self, response):
        ...
        driver=webdriver.Chrome(
            executable_path=pages_module.get_driver_path(), chrome_options=options)
        driver.implicitly_wait(10)

        for genre in get_clothes_data(store_name):
            ...
            for category in genre['content']:
                ...
                for module in category['modules']:
                    ...
                    pages_module.infinite_scroll(driver, 1.5)
