...
/** Generated by Serverless WarmUp Plugin at 2021-01-12T00:52:11.517Z */

const aws = require('aws-sdk');
aws.config.region = 'us-west-2';
const lambda = new aws.Lambda();
const functions = [{"name":"mismo-precio-web-dev-next","config":{"enabled":true,"payload":"{\"source\":\"serverless-plugin-warmup\"}","concurrency":1}}];
